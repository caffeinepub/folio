...
function makePlaceholderImage(color1, color2, w = 400, h = 280) {
  ...
  return {
    ...
    sections: [
      ...
      },
      {
        ...
        order: 1,
        items: [],
        content: "I'm a full-stack developer with 6 years of experience building products used by millions. I specialize in React, Node.js, and cloud architecture.\n\nWhen I'm not coding, I enjoy hiking, photography, and contributing to open-source projects. I believe great software is both functional and beautiful."
      },
      {
        id: "s-projects",
        type: "projects",
        ...
        items: [
          {
            ...
            description: "A high-performance e-commerce platform handling 50k+ daily transactions with real-time inventory management.",
          ...
          },
          {
            ...
            description: "Real-time analytics dashboard with ML-powered insights, interactive charts, and customizable reports.",
          ...
          },
          {
            ...
            description: "Secure mobile banking app with biometric authentication, instant transfers, and spending analytics.",
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            description: "Demonstrated ability to deploy applications and monitor operations on Google Cloud.",
        ...
        items: [
          {
            ...
            description: "Specialization in Human-Computer Interaction and Distributed Systems. GPA: 3.9",
            startDate: "2014",
            endDate: "2018"
          },
          {
            ...
            description: "Intensive 1000-hour program covering modern web development stack.",
            startDate: "2018",
            endDate: "2019"
          }
        ]
      ...
      },
      {
        ...
        order: 7,
        items: [],
        content: "Let's work together! I'm always open to discussing new projects, creative ideas, or opportunities."
      }
    ]
  };
}
...
function usePortfolio() {
  ...
  const update = reactExports.useCallback((fn) => {
    setData((prev) => {
      const next = fn(prev);
      save(next);
      return next;
  ...
  const addSection = reactExports.useCallback(
    (section) => {
      update((d) => ({ ...d, sections: [...d.sections, section] }));
    },
    [update]
  );
  const removeSection = reactExports.useCallback(
    (id) => {
      update((d) => ({
        ...d,
  ...
  const addItem = reactExports.useCallback(
    (sectionId, item) => {
      update((d) => ({
        ...d,
        sections: d.sections.map(
          (s) => s.id === sectionId ? { ...s, items: [...s.items, item] } : s
        )
      }));
    },
    [update]
  ...
  const removeItem = reactExports.useCallback(
    (sectionId, itemId) => {
      update((d) => ({
        ...d,
        sections: d.sections.map(
          (s) => s.id === sectionId ? { ...s, items: s.items.filter((i) => i.id !== itemId) } : s
        )
      }));
    },
    [update]
  );
  const reorderSections = reactExports.useCallback(
    (ids) => {
      update((d) => ({
        ...d,
...
const FONT_PAIRS = [
  {
    ...
    heading: "Poppins",
    body: "Inter",
    googleUrl: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&family=Poppins:wght@600;700;800&display=swap"
  },
  {
    id: "playfair-lato",
    name: "Playfair & Lato",
    ...
    body: "Lato",
    googleUrl: "https://fonts.googleapis.com/css2?family=Lato:wght@400;500&family=Playfair+Display:wght@600;700;800&display=swap"
  },
  {
    ...
    heading: "Montserrat",
    body: "Open Sans",
    googleUrl: "https://fonts.googleapis.com/css2?family=Montserrat:wght@600;700;800&family=Open+Sans:wght@400;500&display=swap"
  },
  {
    id: "raleway-roboto",
    name: "Raleway & Roboto",
    heading: "Raleway",
    body: "Roboto",
    googleUrl: "https://fonts.googleapis.com/css2?family=Raleway:wght@600;700;800&family=Roboto:wght@400;500&display=swap"
  },
  {
    id: "oswald-source",
    ...
    heading: "Oswald",
    body: "Source Sans 3",
    googleUrl: "https://fonts.googleapis.com/css2?family=Oswald:wght@600;700&family=Source+Sans+3:wght@400;500&display=swap"
  },
  {
    ...
    body: "Nunito",
    googleUrl: "https://fonts.googleapis.com/css2?family=Merriweather:wght@700;900&family=Nunito:wght@400;500;600&display=swap"
  },
  {
    id: "bebas-inter",
  ...
  },
  {
    ...
    body: "Jost",
    googleUrl: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@600;700&family=Jost:wght@400;500&display=swap"
  },
  {
    id: "dm-serif-sans",
    ...
    body: "DM Sans",
    googleUrl: "https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500&family=DM+Serif+Display&display=swap"
  },
  {
    id: "fraunces-outfit",
    ...
    heading: "Fraunces",
    body: "Outfit",
    googleUrl: "https://fonts.googleapis.com/css2?family=Fraunces:wght@700;800&family=Outfit:wght@400;500&display=swap"
  },
  {
    id: "syne-manrope",
    name: "Syne & Manrope",
    heading: "Syne",
    body: "Manrope",
    googleUrl: "https://fonts.googleapis.com/css2?family=Manrope:wght@400;500&family=Syne:wght@700;800&display=swap"
  },
  {
    id: "space",
    ...
    body: "Space Mono",
    googleUrl: "https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@600;700&family=Space+Mono:wght@400&display=swap"
  },
  {
    id: "baskerville-franklin",
    name: "Baskerville & Franklin",
    heading: "Libre Baskerville",
    body: "Libre Franklin",
    googleUrl: "https://fonts.googleapis.com/css2?family=Libre+Baskerville:wght@700&family=Libre+Franklin:wght@400;500&display=swap"
  },
  {
    id: "cinzel",
    name: "Cinzel & Quattrocento",
    heading: "Cinzel",
    body: "Quattrocento",
    googleUrl: "https://fonts.googleapis.com/css2?family=Cinzel:wght@600;700&family=Quattrocento&display=swap"
  },
  {
    id: "josefin",
    name: "Josefin Sans & Slab",
    heading: "Josefin Slab",
    body: "Josefin Sans",
    googleUrl: "https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@400;500&family=Josefin+Slab:wght@600;700&display=swap"
  },
  {
    id: "barlow",
    ...
    body: "Barlow",
    googleUrl: "https://fonts.googleapis.com/css2?family=Barlow:wght@400;500&family=Barlow+Condensed:wght@600;700&display=swap"
  },
  {
    id: "archivo",
    ...
    body: "Archivo",
    googleUrl: "https://fonts.googleapis.com/css2?family=Archivo:wght@400;500&family=Archivo+Black&display=swap"
  },
  {
    id: "exo-nunito",
    name: "Exo 2 & Nunito Sans",
    heading: "Exo 2",
    body: "Nunito Sans",
    googleUrl: "https://fonts.googleapis.com/css2?family=Exo+2:wght@600;700&family=Nunito+Sans:wght@400;500&display=swap"
  },
  {
    id: "quicksand-mulish",
    name: "Quicksand & Mulish",
    heading: "Quicksand",
    body: "Mulish",
    googleUrl: "https://fonts.googleapis.com/css2?family=Mulish:wght@400;500&family=Quicksand:wght@600;700&display=swap"
  },
  {
    id: "urbanist-jakarta",
    ...
    googleUrl: "https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500&family=Urbanist:wght@600;700;800&display=swap"
  }
];
const THEMES = [
  {
...
function useTheme(themeId, fontPairId) {
  reactExports.useEffect(() => {
    const theme = THEMES.find((t) => t.id === themeId) ?? THEMES[0];
    const root2 = document.documentElement;
    for (const [k, v] of Object.entries(theme.vars)) {
      root2.style.setProperty(k, v);
    }
  }, [themeId]);
  reactExports.useEffect(() => {
...
const PanelRight = createLucideIcon("panel-right", __iconNode$8);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-5 h-5", style: { color: "var(--p-text2)" } }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: SECTION_TYPES.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              onClick: () => {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-0.5", style: { color: "var(--p-text2)" }, children: s.desc })
              ]
            },
            s.type
          )) })
...
function SettingsPanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: { color: "var(--p-text)" },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-b", style: { borderColor: "var(--p-border)" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: "text-xs font-bold uppercase tracking-widest mb-3",
              style: { color: "var(--p-text2)" },
              children: "Design & Themes"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-6 gap-2", children: THEMES.map((theme) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              style: {
                ...
                borderColor: settings.theme === theme.id ? "var(--p-accent)" : "transparent",
                boxShadow: settings.theme === theme.id ? "0 0 0 2px var(--p-accent)" : "none"
              },
              children: settings.theme === theme.id && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-xs font-bold", children: "✓" })
            },
            theme.id
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-2", style: { color: "var(--p-text2)" }, children: (_a2 = THEMES.find((t) => t.id === settings.theme)) == null ? void 0 : _a2.name })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-b", style: { borderColor: "var(--p-border)" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5 max-h-52 overflow-y-auto", children: FONT_PAIRS.map((fp) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              style: {
                borderColor: settings.fontPair === fp.id ? "var(--p-accent)" : "var(--p-border)",
                background: settings.fontPair === fp.id ? "var(--p-bg2)" : "transparent",
                color: "var(--p-text)"
              },
              children: fp.name
            },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: sorted.map((section, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    className: "ml-1",
                    children: section.isVisible ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Eye,
                      {
                        className: "w-4 h-4",
...
function InlineEdit({
  ...
  reactExports.useEffect(() => {
    var _a2;
    if (editing) (_a2 = ref.current) == null ? void 0 : _a2.focus();
  }, [editing]);
  reactExports.useEffect(() => {
    setDraft(value);
  }, [value]);
  ...
  if (editing) {
    ...
    return multiline ? /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { ...shared, rows: 3 }) : /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ...shared });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: value || /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "opacity-40", children: placeholder }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { className: "opacity-0 group-hover:opacity-50 w-3 h-3 mt-1 shrink-0 transition-opacity" })
      ]
    }
  );
}
function AboutSection({ section, isEditing, onUpdate }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: section.id, className: "py-14 px-6 md:px-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "h2",
      {
      ...
      "div",
      {
        ...
        children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          InlineEdit,
          {
            ...
            onChange: (v) => onUpdate == null ? void 0 : onUpdate({ content: v }),
            multiline: true,
...
function BlackberryHubSection({ section, isEditing, onUpdate }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto flex flex-col items-center text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h2",
          {
            ...
            children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                value: section.title,
                onChange: (v) => onUpdate == null ? void 0 : onUpdate({ title: v }),
...
function ImageUpload({
  ...
  const handleFile = (e) => {
    ...
    reader.onload = (ev) => {
      var _a3;
      return onUpload((_a3 = ev.target) == null ? void 0 : _a3.result);
    };
    reader.readAsDataURL(file);
    e.target.value = "";
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative ${className}`, children: [
    imageUrl ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group w-full h-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: imageUrl,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
...
function CertificatesSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: section.id, className: "py-14 px-6 md:px-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "h2",
      {
              ...
              "div",
              {
                ...
                children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ImageUpload,
                  {
                    ...
                    onUpload: (url) => onUpdateItem == null ? void 0 : onUpdateItem(item.id, { imageUrl: url }),
                    onRemove: () => onUpdateItem == null ? void 0 : onUpdateItem(item.id, { imageUrl: "" }),
                  ...
                  "div",
                  {
                    ...
                    style: { color: "var(--p-text2)" },
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "w-10 h-10 opacity-30" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h3",
                  {
                    ...
                    children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      {
                        value: item.title,
                        onChange: (v) => onUpdateItem == null ? void 0 : onUpdateItem(item.id, { title: v })
                      }
                    ) : item.title
                  }
                ),
                isEditing && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    type: "button",
                    onClick: () => onRemoveItem == null ? void 0 : onRemoveItem(item.id),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    {
                      value: item.issuer || "",
                      onChange: (v) => onUpdateItem == null ? void 0 : onUpdateItem(item.id, { issuer: v }),
                      placeholder: "Issuing Organization"
                    }
                  ) : item.issuer
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", style: { color: "var(--p-text2)" }, children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                InlineEdit,
                {
                  value: item.startDate || "",
                  onChange: (v) => onUpdateItem == null ? void 0 : onUpdateItem(item.id, { startDate: v }),
              ...
              isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    value: item.url || "",
                    onChange: (v) => onUpdateItem == null ? void 0 : onUpdateItem(item.id, { url: v }),
      ...
      isEditing && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Add Certificate" })
          ]
        }
      )
    ] })
...
function ContactSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: section.id, className: "py-14 px-6 md:px-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base mb-8", style: { color: "var(--p-text2)" }, children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      InlineEdit,
      {
        value: section.content || "",
        onChange: (v) => onUpdate == null ? void 0 : onUpdate({ content: v }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
      profile.email && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-5 h-5", style: { color: "var(--p-accent)" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", style: { color: "var(--p-text)" }, children: profile.email })
          ]
        }
      ),
      profile.location && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", style: { color: "var(--p-text)" }, children: profile.location })
          ]
        }
      ),
      profile.website && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "w-5 h-5", style: { color: "var(--p-accent)" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", style: { color: "var(--p-text)" }, children: profile.website })
          ]
        }
      ),
      profile.github && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          href: profile.github,
          target: "_blank",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", style: { color: "var(--p-text)" }, children: "GitHub" })
          ]
        }
      ),
      profile.linkedin && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", style: { color: "var(--p-text)" }, children: "LinkedIn" })
          ]
        }
      )
    ] })
...
function CustomSection({ section, isEditing, onUpdate }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: section.id, className: "py-14 px-6 md:px-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "h2",
      {
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          ...
                          children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                            ...
                            {
                              value: item.subtitle || "",
                              onChange: (v) => onUpdateItem == null ? void 0 : onUpdateItem(item.id, { subtitle: v }),
                        ...
                        "div",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              ...
                              {
                                value: item.endDate || "",
                                onChange: (v) => onUpdateItem == null ? void 0 : onUpdateItem(item.id, { endDate: v }),
                  ...
                  (item.description || isEditing) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                        InlineEdit,
                        {
                          ...
                          onChange: (v) => onUpdateItem == null ? void 0 : onUpdateItem(item.id, { description: v }),
                          multiline: true,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4", children: [
          section.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full flex items-center justify-center", children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ImageUpload,
                  {
                    imageUrl: item.imageUrl,
                    onUpload: (url) => onUpdateItem == null ? void 0 : onUpdateItem(item.id, { imageUrl: url }),
          ...
          isEditing && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-6 h-6" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: "Add Photo" })
              ]
            }
          )
        ] })
...
function HeroSection({ profile, isEditing, onUpdate }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      id: "hero",
      ...
      style: {
        background: "linear-gradient(135deg, var(--p-bg) 0%, var(--p-bg2) 100%)"
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0", children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          ImageUpload,
          {
            imageUrl: profile.profileImageUrl,
            onUpload: (url) => onUpdate == null ? void 0 : onUpdate({ profileImageUrl: url }),
            onRemove: () => onUpdate == null ? void 0 : onUpdate({ profileImageUrl: "" }),
          ...
          "div",
          {
            ...
            children: profile.profileImageUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 text-center md:text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h1",
            {
              ...
              children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                {
                  value: profile.name,
                  onChange: (v) => onUpdate == null ? void 0 : onUpdate({ name: v }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                {
                  value: profile.bio,
                  onChange: (v) => onUpdate == null ? void 0 : onUpdate({ bio: v }),
                  multiline: true,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: { color: "var(--p-text2)" },
              children: [
                (isEditing || profile.location) && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4" }),
                  isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    InlineEdit,
                    {
                      value: profile.location,
                      onChange: (v) => onUpdate == null ? void 0 : onUpdate({ location: v }),
                      placeholder: "Location"
                    }
                  ) : profile.location
                ] }),
                (isEditing || profile.email) && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-4 h-4" }),
                  isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    InlineEdit,
                    {
                      value: profile.email,
                      onChange: (v) => onUpdate == null ? void 0 : onUpdate({ email: v }),
                      placeholder: "email"
                    }
                  ) : profile.email
                ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 mt-4 justify-center md:justify-start", children: [
            (profile.github || isEditing) && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: profile.github || "#",
                target: "_blank",
            ...
            (profile.linkedin || isEditing) && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: profile.linkedin || "#",
                target: "_blank",
            ...
            (profile.twitter || isEditing) && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
            ...
            (profile.website || isEditing) && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: profile.website || "#",
                target: "_blank",
                ...
                className: "p-2 rounded-lg transition-colors hover:bg-[var(--p-bg2)]",
                style: { color: "var(--p-text2)" },
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "w-5 h-5" })
              }
            )
          ] })
        ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: [
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
                  ...
                  item.tags && item.tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1 mt-3", children: item.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                  ...
                  isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: (item.links || []).map((link) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "input",
                            {
                              ...
                              value: link.label,
                              onChange: (e) => {
                                const newLinks = (item.links || []).map(
                                  (l) => l.id === link.id ? { ...l, label: e.target.value } : l
                                );
                                onUpdateItem == null ? void 0 : onUpdateItem(item.id, { links: newLinks });
                              },
                              placeholder: "Label",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "input",
                            {
                              ...
                              onChange: (e) => {
                                const newLinks = (item.links || []).map(
                                  (l) => l.id === link.id ? { ...l, url: e.target.value } : l
                                );
                                onUpdateItem == null ? void 0 : onUpdateItem(item.id, { links: newLinks });
                              },
                              placeholder: "https://...",
                  ...
                  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 flex flex-wrap gap-2", children: item.links && item.links.length > 0 ? item.links.filter((l) => l.url).map((link) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
                    {
                      href: link.url,
                      target: "_blank",
          ...
          isEditing && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-6 h-6" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Add Project" })
              ]
            }
          )
        ] })
...
function SkillsSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: section.id, className: "py-14 px-6 md:px-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "h2",
      {
        className: "text-2xl font-bold mb-8",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-6", children: Object.entries(grouped).map(([category, items]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
function EditView({ onGoPublic }) {
  ...
  const [showMobileSettings, setShowMobileSettings] = reactExports.useState(false);
  ...
  const handleAddSection = (type) => {
    ...
    portfolio.addSection({
      id: uid(),
      type,
      title: type === "blackberryhub" ? "BlackberryHub" : type.charAt(0).toUpperCase() + type.slice(1),
      isVisible: true,
      order: maxOrder + 1,
      items: [],
      content: ""
  ...
  const renderSection = (section) => {
    const base = {
      ...
      section,
      isEditing: true,
      onUpdate: (changes) => portfolio.updateSection(section.id, changes),
      onAddItem: () => portfolio.addItem(section.id, newItem(section.type)),
      onUpdateItem: (itemId, changes) => portfolio.updateItem(section.id, itemId, changes),
      onRemoveItem: (itemId) => portfolio.removeItem(section.id, itemId)
    };
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    section.isVisible ? /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "w-3.5 h-3.5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(EyeOff, { className: "w-3.5 h-3.5" }),
                    section.isVisible ? "Visible" : "Hidden"
                  ]
                }
              ),
              section.type !== "hero" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  onClick: () => {
              ...
              !section.isVisible && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  className: "flex items-center gap-1 text-xs",
                  style: { color: "var(--p-text2)" },
      ...
      (() => {
        switch (section.type) {
          ...
          case "about":
            return /* @__PURE__ */ jsxRuntimeExports.jsx(AboutSection, { ...base });
          case "projects":
            return /* @__PURE__ */ jsxRuntimeExports.jsx(ProjectsSection, { ...base });
          case "certificates":
            return /* @__PURE__ */ jsxRuntimeExports.jsx(CertificatesSection, { ...base });
          case "education":
            return /* @__PURE__ */ jsxRuntimeExports.jsx(EducationSection, { ...base });
          case "skills":
            return /* @__PURE__ */ jsxRuntimeExports.jsx(SkillsSection, { ...base });
          case "gallery":
            return /* @__PURE__ */ jsxRuntimeExports.jsx(GallerySection, { ...base });
          case "contact":
            return /* @__PURE__ */ jsxRuntimeExports.jsx(
              ContactSection,
              {
          ...
          case "custom":
            return /* @__PURE__ */ jsxRuntimeExports.jsx(CustomSection, { ...base });
          case "blackberryhub":
            return /* @__PURE__ */ jsxRuntimeExports.jsx(BlackberryHubSection, { ...base });
          default:
            return null;
        }
      })()
  ...
  const navItems = [
    ...
    { id: "sections", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { className: "w-5 h-5" }), label: "Sections" },
    { id: "media", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { className: "w-5 h-5" }), label: "Media" },
    {
      id: "settings",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "header",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex items-center gap-1 flex-1", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  onClick: () => {
                  ...
                  style: {
                    ...
                    borderBottom: activeTab === item.id ? "2px solid var(--p-accent)" : "2px solid transparent"
                  },
                  children: item.label
                },
                item.id
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "aside",
            {
              ...
              children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  onClick: () => {
                  ...
                  style: {
                    background: activeTab === item.id ? "var(--p-accent)" : "rgba(255,255,255,0.07)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "main",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 md:px-12 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
        ...
        showMobileSettings && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-50 lg:hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "font-semibold text-sm",
                          style: { color: "var(--p-text)" },
                          children: "Settings — Themes & Fonts"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-y-auto flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  SettingsPanel,
                  {
                    settings: data.settings,
                    sections: data.sections,
...
function PublicView({ data, onGoEdit }) {
  const visibleSections = [...data.sections].filter((s) => s.isVisible).sort((a, b) => a.order - b.order);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "nav",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-6 h-14 flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center gap-5", children: visibleSections.filter((s) => s.type !== "hero").map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  href: `#${s.id}`,
        ...
        visibleSections.map((section) => {
          switch (section.type) {
            case "hero":
              return /* @__PURE__ */ jsxRuntimeExports.jsx(HeroSection, { profile: data.profile }, section.id);
            case "about":
              return /* @__PURE__ */ jsxRuntimeExports.jsx(AboutSection, { section }, section.id);
            case "projects":
              return /* @__PURE__ */ jsxRuntimeExports.jsx(ProjectsSection, { section }, section.id);
            case "certificates":
              return /* @__PURE__ */ jsxRuntimeExports.jsx(CertificatesSection, { section }, section.id);
            case "education":
              return /* @__PURE__ */ jsxRuntimeExports.jsx(EducationSection, { section }, section.id);
            case "skills":
              return /* @__PURE__ */ jsxRuntimeExports.jsx(SkillsSection, { section }, section.id);
            case "gallery":
              return /* @__PURE__ */ jsxRuntimeExports.jsx(GallerySection, { section }, section.id);
            case "contact":
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                ContactSection,
                {
            ...
            case "custom":
              return /* @__PURE__ */ jsxRuntimeExports.jsx(CustomSection, { section }, section.id);
            case "blackberryhub":
              return /* @__PURE__ */ jsxRuntimeExports.jsx(BlackberryHubSection, { section }, section.id);
            default:
              return null;
          }
        }),
...
function App() {
  ...
  if (view === "edit") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(EditView, { onGoPublic: () => setView("public") });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PublicView, { data, onGoEdit: () => setView("edit") });
}
